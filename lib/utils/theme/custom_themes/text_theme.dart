...
class MTextTheme{
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    bodyMedium: const TextStyle().copyWith(fontSize: 12.0,fontWeight: FontWeight.w400,color: Colors.black),
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    headlineMedium: const TextStyle().copyWith(fontSize: 22.0,fontWeight: FontWeight.w400, color: Colors.white),
